...
const app = express()
const store = new ExerciseStore(path.join(__dirname, 'data', 'exercise-tracker.json'))
...
app.post('/api/users/:_id/exercises', (req, res, next) => {
  try {
    ...
    const exerciseDate = parseDateParam(req.body.date, 'date') || formatExerciseDate(new Date())
...
app.get('/api/users/:_id/logs', (req, res, next) => {
  try {
    ...
    const visibleExercises = limit === null ? matchingExercises : matchingExercises.slice(0, limit)
